...
public class TheTichView extends javax.swing.JFrame {
    ...
    public void fillTable(List<TheTich> list) {
        ...
        for (TheTich theTich : list) {
            tableModel.addRow(new Object[]{
                stt++ ,
                theTich.getMaTheTich(),
                theTich.getTenTheTich()
            });
        }
    }
    ...
    public boolean CheckData() {
        ...
        if (theTichSerivce.checkHv(txtmatt.getText())){
        ...
        if (txttentt.getText().trim().isEmpty()) {
          ...
          if (theTichSerivce.isTenSanPhamExists(txttentt.getText().trim())){

...
public class NhaCungCapView extends javax.swing.JFrame {
    ...
    public boolean CheckData() {
        ...
        if (nhaCungCapSerive.checkNcc(txtmancc.getText())) {
        ...
        if (nhaCungCapSerive.isTenSanPhamExists(txttenncc.getText().trim())) {
            JOptionPane.showMessageDialog(this, "Trùng tên vui lòng nhập lại");
            return false;
        }
        if (!txtsdt.getText().trim().matches(regexPhone)) {
        ...
        List<NhaCungCap> listNCC = nhaCungCapSerive.getList();

        for (NhaCungCap nhaCungCap : listNCC) {
            if (nhaCungCap.getEmail().equalsIgnoreCase(txtemail.getText().trim())) {
                JOptionPane.showMessageDialog(this, "Email nhà cung cấp đã tồn tại");
                return false;
            }
            if (nhaCungCap.getSoDT().equalsIgnoreCase(txtsdt.getText().trim())) {
    ...
    private void initComponents() {
        ...
        tbltable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Nhà CC", "Tên Nhà CC", "Số điện thoại", "Email", "Địa Chỉ"
            }
        ));

...
public class DoiTuongView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbldoituong.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã đối tượng", "Tên đối tượng"
            }
        ));
...
public DoiTuong readForm() {
    ...
    public void fillTable(List<DoiTuong> list) {
        ...
        for (DoiTuong doiTuong : list) {
            tableModel.addRow(new Object[]{
                stt++ ,
                doiTuong.getMaDoiTuong(),
                doiTuong.getTenDoiTuongSD()
            });
        }
    }
    ...
    public boolean CheckData() {
        ...
        if (doiTuongService.checkMaDT(txtmadt.getText())) {
        ...
        if (doiTuongService.isTenSanPhamExists(txttendt.getText().trim())){
    ...
    private void btnxoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnxoaMouseClicked
        ...
        if (index == -1) {
            ...
            String ma = tbldoituong.getValueAt(index, 1).toString();
    ...
    private void btnupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnupdateMouseClicked
        ...
        if (index == -1) {
            ...
            String id = tbldoituong.getValueAt(index, 1).toString();

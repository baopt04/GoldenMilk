 ...
 * @author Computer Bao
 */
public class HuongViView extends javax.swing.JFrame {
    ...
    public HuongViView() {
        ...
        fillTable(huongViSerivce.getList());
    }

    public HuongVi readForm() {
        String ma, ten;
        ma = txtmahuongvi.getText();
        ten = txttenhv.getText();
        return new HuongVi(ma, ten);
    }

    public void fillTable(List<HuongVi> list) {
        tableModel = (DefaultTableModel) tbltable.getModel();
        tableModel.setRowCount(0);
        int stt = 1;
        for (HuongVi huongVi : list) {
            tableModel.addRow(new Object[]{
            stt++ ,
            huongVi.getMaHuongVi(),
            huongVi.getTenHuongVi()});
        }
    }

    public boolean CheckData() {
        if (txtmahuongvi.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập mã");
            return false;
        }
        if (huongViSerivce.checkHv(txtmahuongvi.getText())) {
        ...
        if (txttenhv.getText().trim().isEmpty()) {
            ...
            return false;
        }  if (huongViSerivce.isTenSanPhamExists(txttenhv.getText().trim())){
    ...
    public void showData(int index) {
        HuongVi doiTuong = huongViSerivce.getList().get(index);
        txtmahuongvi.setText(doiTuong.getMaHuongVi());
        txttenhv.setText(doiTuong.getTenHuongVi());
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tên hương vị:");

        jLabel4.setForeground(new java.awt.Color(51, 204, 255));
        jLabel4.setText("Mã hương vị: ");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txttenhv, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if (index == -1) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                if (huongViSerivce.update(doiTuong, id) > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HuongViView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HuongViView().setVisible(true);
            }
        });
    }

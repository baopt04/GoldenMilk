...
public class HangView extends javax.swing.JFrame {
    ...
    public void fillTable(List<HangSanPham> list) {
        ...
        for (HangSanPham hangSanPham : list) {
            tableModel.addRow(new Object[]{
                stt++,
                hangSanPham.getMaHangSanPham(),
                hangSanPham.getTenHangSanPham()
            });
        }
    }
    ...
    public boolean CheckData() {
        ...
        if (hangService.checkhang(txtmahang.getText())) {
        ...
        if (txttenhang.getText().trim().isEmpty()) {
          ...
          if (hangService.isTenSanPhamExists(txttenhang.getText().trim())){
    ...
    private void initComponents() {
        ...
        tbltable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã hãng sản phẩm", "Tên hãng sản phẩm"
            }
        ));
